...
"""--- --- --- --- --- SETTINGS & CONFIG --- --- --- --- ---"""
"""--- MODEL ---"""
numTokensPerStep = 512   # Number of tokens to predict per step, // 1024 = crash, 512 is POSSIBLE but its the slowest thing in existence.
...
trainingDataSliceSize_max = 30000
reflectionFreq = 3456
# --- #
trainingDataPairNumber = 10000 #169420
