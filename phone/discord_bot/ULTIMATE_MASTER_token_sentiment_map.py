...
class UltimateMasterSentimentAnalyser:
    ...
    def analyse_token_sequence(self, token_ids: List[int]) -> Dict:
        ...
        for token_id in token_ids:
            ...
            if self.is_amplifier(token_id):
                ...
                results["amplifier_tokens"].append(
                    {"id": token_id, "text": token_text, "multiplier": amp_value}
                )
        ...
        results["coverage_percent"] = (
            (tokens_with_sentiment / len(token_ids)) * 100 if token_ids else 0
        )
    ...
    def get_sentiment_summary(self) -> Dict:
        ...
        return {
            ...
            "coverage_percentage": (
                len(self.all_sentiment_tokens) / len(self.baby_vocab)
            )
            * 100
            if self.baby_vocab
            else 0,
...
if __name__ == "__main__":
    ...
    print("MASTER SENTIMENT STATISTICS:")
