...
# --- NEW: Define a shared state container ---
class AppState:
    # Bot instances will be stored here when they're created
    discord_bot_instance: 'BABYBOT_DISCORD' = None
    twitch_bot_instance: 'BABYBOT_TWITCH' = None
    
    # LLM and other components
    llm: 'BABYLLM' = None
    tutor: 'TUTOR' = None
    librarian: 'LIBRARIAN' = None
    
    # State for the Vue.js frontend
    web_state = {
        ...
        "R": 133, "G": 239, "B": 238, "tintStrength": 1.0,
        "isSpeaking": False, "speech": "",
    }
    
    # A single, unified message buffer
    message_buffer = []
