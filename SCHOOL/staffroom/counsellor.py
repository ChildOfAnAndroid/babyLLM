    ...
    def infodump(self, _functionName, _extra=None, _key=None):
        ...
        class TANGENT:
            def __init__(self, _parent):
                ...
                setattr(
                    self, "ʕっʘ‿ʘʔっ", self.infodump
                )  # SOMEHOW LEGAL AS A VARIABLE NAME HOW HAVE I DONE THIS PLEASE PROTECT ME LOL
            ...
            def infodump(self, _innerName):
                ...
                if self.lastInfodumpName:
                    ...
                    if self.parent.debugPrints:
                        if duration > 3.0:
                            print(
                                f"\033[38;2;57;255;20m\033[48;2;255;0;255m♥ finished {self.parent.className}♥{tag} in {duration:.4f}s ♥\033[0m\033[2m"
                            )
                        elif duration > 0.3:
                            print(
                                f"\033[38;2;255;128;0m\033[1m\033[4m♥ finished {self.parent.className}♥{tag} in {duration:.4f}s ♥\033[0m\033[2m"
                            )
                        if False:
                            print(
                                f"♥ finished {self.parent.className}♥{tag} in {duration:.4f}s ♥"
                            )
            ...
            if tangent.lastInfodumpName:
                ...
                if self.debugPrints:
                    if finalDuration > 3.0:
                        print(
                            f"\033[38;2;57;255;20m\033[48;2;255;0;255m♥ finished {self.className}♥{finalTag} in {finalDuration:.4f}s ♥\033[0m\033[2m"
                        )
                    elif finalDuration > 0.3:
                        print(
                            f"\033[38;2;255;128;0m\033[1m\033[4m♥ finished {self.className}♥{finalTag} in {finalDuration:.4f}s ♥\033[0m\033[2m"
                        )
                    if False:
                        print(
            ...
            if startStamp:
                ...
                if self.debugPrints:
                    if totalDuration > 3.0:
                        print(
                            f"\033[38;2;57;255;20m\033[48;2;255;0;255m(っ◕‿◕)っ finished {fullTitle} in {totalDuration:.4f}s (｡♥‿♥｡)\033[0m\033[2m"
                        )
                    elif totalDuration > 0.3:
                        print(
                            f"\033[38;2;255;128;0m\033[1m\033[4m(っ◕‿◕)っ finished {fullTitle} in {totalDuration:.4f}s (｡♥‿♥｡)\033[0m\033[2m"
                        )
                    if False:
                        print(
                            f"(っ◕‿◕)っ finished {fullTitle} in {totalDuration:.4f}s (｡♥‿♥｡)"
                        )
            elif self.debugPrints:
                if totalDuration > 3.0:
                    print(
                        f"\033[38;2;57;255;20m\033[48;2;255;0;255m(っ◕‿◕)っ finished {fullTitle} (｡♥‿♥｡)\033[0m\033[2m"
                    )
                elif totalDuration > 0.3:
                    print(
                        f"\033[38;2;255;128;0m\033[1m\033[4m(っ◕‿◕)っ finished {fullTitle} (｡♥‿♥｡)\033[0m\033[2m"
                    )
                if False:
