...
with open(
    "/Users/charis/Documents/GitHub/Shkaira/SCHOOL/statistics/LOGS/training/trainingLog_100.txt",
    "r",
) as f:
    lines = f.readlines()
...
for line in lines:
    ...
    timestamp_match = re.match(
        r"^(\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2})\s*\|\s*(\d+)\s*\|", line
    )
...
with open(
    "/Users/charis/Documents/GitHub/Shkaira/SCHOOL/statistics/LOGS/training/trainingLog_100_withTotalSteps.txt",
    "w",
) as f:
    f.writelines(output)
