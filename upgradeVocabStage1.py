...
new_tokenToIndex_path = "BRAIN/vocabCache/vocab4200_20_to_index.json"
new_indexToToken_path = "BRAIN/vocabCache/vocab4200_20_to_token.json"
new_vocabList_path   = "BRAIN/vocabCache/vocab4200_20_list.json"
...
# Append new tokens to unused indices
next_free_index = max(used_indices) + 1
for token in new_tokenToIndex:
    if token not in old_tokenToIndex:
